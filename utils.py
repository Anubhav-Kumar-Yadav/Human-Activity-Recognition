...
class Videos(object):
    ...
    def __init__(self, target_size=None, to_gray=True, max_frames=None, extract_frames='middle', required_fps=None, normalize_pixels=None):
        """
    ...
    def _process_video(self, video):
        ...
        if self.max_frames <= total_frames:
            ...
            raise IndexError('Required number of frames is greater than the total number of frames in the video')
